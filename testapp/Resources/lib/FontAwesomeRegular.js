/* FontAwesome v. 3.2.1 */
function FontAwesomeRegular(options) {
	switch (Ti.Platform.osname) {
		case 'iphone':
			this.fontfamily = 'FontAwesomeLight';
			break;
		case 'ipad':
			this.fontfamily = 'FontAwesomeLight';
			break;
	...
	this.charcode = {
		...
		"icon-print" : 0xf02f,
		"icon-camera" : 0xf030,
        "icon-camera-slash" : 0xe0d9,
		"icon-camera-rotate" : 0xe0d8,
		"icon-font" : 0xf031,
		"icon-bold" : 0xf032,
		"icon-italic" : 0xf033,
...
FontAwesomeRegular.prototype.getCharcode = function(options) {
	return this.charcode[options];
};


module.exports = FontAwesomeRegular;